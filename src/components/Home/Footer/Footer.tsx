    ...
    return (
        <>
            ...
            <footer className="text-center text-lg-start text-muted backgroundImage mt-0">
                ...
                <section className="d-flex justify-content-center justify-content-lg-between p-5">
                    <div className="container-md me-5 d-none d-lg-block">
                        ...
                        <div className="row mt-3">
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                <h5 className="text-uppercase fw-bold mb-3">
                                    <i className="fas fa-gem me-0"></i>Animal Save
                                </h5>
                                <p>
