...
import "./NewSupplierModal.styles.css";
    ...
    return (
        <>
            <section className="container-fluid px-0">
                <div className="modal fade" id="newSupplierModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
