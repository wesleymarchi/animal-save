...
import "./EditSupplierModal.styles.css";
    ...
    return (
        <>
            <section className="container-fluid px-0">
                <div className="modal fade" id="editSupplierModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="staticBackdropLabel">Editar Parceiro</h1>
