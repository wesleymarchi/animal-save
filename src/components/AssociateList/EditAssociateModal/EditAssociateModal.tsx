...
import "./EditAssociateModal.styles.css";

const EditAssociateModal = () => {

    return (
        <>
            <section className="container-fluid px-0">
                <div className="modal fade" id="editAssociateModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
