...
import "./NewAssociateModal.styles.css";

const NewAssociateModal = () => {

    return (
        <>
            <section className="container-fluid px-0">
                <div className="modal fade" id="newAssociateModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
